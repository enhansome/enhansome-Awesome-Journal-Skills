...
[![Claude Code](https://img.shields.io/badge/agent-Claude%20Code-cc785c)](https://github.com/anthropics/claude-code) ⭐ 147,808 | 🐛 12,474 | 🌐 TypeScript | 📅 2026-09-23
...
| **第三方收录（外链）**，例如 [nature-skills](https://github.com/Yuan1z0825/nature-skills) ⭐ 44,220 \| 🐛 2 \| 🌐 Python \| 📅 2026-09-22、[claude-scholar](https://github.com/Galaxy-Dawn/claude-scholar) ⭐ 5,614 \| 🐛 3 \| 🌐 Python \| 📅 2026-09-23 或 [codex-claude-academic-skills](https://github.com/zLanqing/codex-claude-academic-skills) ⭐ 4,244 \| 🐛 2 \| 🌐 Python \| 📅 2026-05-14 | 第三方上游包或通用学术工具，以外链形式收录（不再 vendored 进本仓库）。                 | 你需要跨期刊的研究、写作或工作流支持。            |
...
| 期刊                                 | 仓库                                                                                                                 | 学科             | 状态       |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------ | -------------- | -------- |
| **Nature**（学术表达 + 科研绘图）            | [nature-skills](https://github.com/Yuan1z0825/nature-skills) ⭐ 44,220 \| 🐛 2 \| 🌐 Python \| 📅 2026-09-22        | 自然科学（Nature 系） | upstream |
| **Nature 风格手稿**（起草 · 修改 · 审计 · 重投） | [Nature-Paper-Skills](https://github.com/Boom5426/Nature-Paper-Skills) ⭐ 509 \| 🐛 0 \| 🌐 Python \| 📅 2026-09-05 | 自然科学（Nature 系） | upstream |

### 通用研究工具 —— 第三方收录

| Pack                        | 仓库                                                                                                                                     | 范围                                              | 状态       |
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- | -------- |
| **Claude Scholar**          | [claude-scholar](https://github.com/Galaxy-Dawn/claude-scholar) ⭐ 5,614 \| 🐛 3 \| 🌐 Python \| 📅 2026-09-23                          | 选题 → 写作 → 发表（Claude Code / OpenCode / Codex）    | upstream |
| **Codex/Claude 学术 Skills**  | [codex-claude-academic-skills](https://github.com/zLanqing/codex-claude-academic-skills) ⭐ 4,244 \| 🐛 2 \| 🌐 Python \| 📅 2026-05-14 | 阅读 · 写作 · 科学计算                                  | upstream |
| **Econ Writing Skill**      | [econ-writing-skill](https://github.com/hanlulong/econ-writing-skill) ⭐ 619 \| 🐛 0 \| 🌐 Python \| 📅 2026-07-20                      | 经济学论文写作：50+ 权威指南提炼（Claude Code / Codex）         | upstream |
...
* [academic-research-skills](https://github.com/Imbad0202/academic-research-skills) ⭐ 49,298 | 🐛 36 | 🌐 Python | 📅 2026-09-23 — 通用的 research → write → review → revise → finalize 科研流水线 skill 包。
* [Awesome-Agent-Skills-for-Empirical-Research](https://github.com/brycewang-stanford/Awesome-Agent-Skills-for-Empirical-Research) ⭐ 4,346 | 🐛 0 | 🌐 Stata | 📅 2026-09-23 — 精选 23,000+ agent skills，覆盖 8 大社科学科的实证研究（由 CoPaper.AI / Stanford REAP 维护）。

以外链形式收录（不再 vendored 进本仓库；点击前往各自上游仓库）：

* [nature-skills](https://github.com/Yuan1z0825/nature-skills) ⭐ 44,220 | 🐛 2 | 🌐 Python | 📅 2026-09-22
* [claude-scholar](https://github.com/Galaxy-Dawn/claude-scholar) ⭐ 5,614 | 🐛 3 | 🌐 Python | 📅 2026-09-23
* [codex-claude-academic-skills](https://github.com/zLanqing/codex-claude-academic-skills) ⭐ 4,244 | 🐛 2 | 🌐 Python | 📅 2026-05-14
* [Nature-Paper-Skills](https://github.com/Boom5426/Nature-Paper-Skills) ⭐ 509 | 🐛 0 | 🌐 Python | 📅 2026-09-05

通用的科研写作 skill 包（定位不同——非特定期刊，仅供参考）：

* [Research-Paper-Writing-Skills](https://github.com/Master-cai/Research-Paper-Writing-Skills) ⭐ 7,066 | 🐛 1 | 📅 2026-06-23 —— ML/CV/NLP 论文写作，源自彭思达老师公开笔记。
* [claude-scientific-writer](https://github.com/K-Dense-AI/claude-scientific-writer) ⭐ 2,385 | 🐛 3 | 🌐 Python | 📅 2026-08-19 / [scientific-agent-skills](https://github.com/k-dense-ai/scientific-agent-skills) ⭐ 46,342 | 🐛 15 | 🌐 Python | 📅 2026-09-21 —— 通用科学写作。
* [academic-paper-skills](https://github.com/lishix520/academic-paper-skills) ⭐ 1,336 | 🐛 1 | 🌐 Python | 📅 2026-01-04 —— strategist（规划）+ composer（写作）双 skill，含质量检查点。
* [qinyan-academic-skills](https://github.com/LeonChaoX/qinyan-academic-skills) ⭐ 924 | 🐛 0 | 🌐 Python | 📅 2026-07-20 —— 沁言学术，177+ skill，覆盖 17 个学科。
* [agent-research-skills](https://github.com/lingzhi227/agent-research-skills) ⭐ 358 | 🐛 5 | 🌐 Python | 📅 2026-02-27 —— deep-research 系统性文献综述。
* [academic-writing-agents](https://github.com/andrehuang/academic-writing-agents) ⭐ 204 | 🐛 1 | 📅 2026-05-11 —— 多 agent 编排，含审稿/检索/起草/润色等专家 agent。
...
* [claude-scientific-skills](https://github.com/K-Dense-AI/claude-scientific-skills) ⭐ 46,342 | 🐛 15 | 🌐 Python | 📅 2026-09-21（K-Dense）—— 140+ 科学 skill + 100+ 科学数据库，覆盖生物/化学/医学，兼容开放 Agent Skills 标准。
* [SciAgent-Skills](https://github.com/jaechang-hits/SciAgent-Skills) ⭐ 367 | 🐛 6 | 🌐 Python | 📅 2026-08-29 —— 197 个生物信息与生命科学 skill（RNA-seq、单细胞、蛋白组、药物发现）。
...
| ⚙️ **开源引擎**  | **[StatsPAI](https://github.com/brycewang-stanford/StatsPAI) ⭐ 323 \| 🐛 0 \| 🌐 Python \| 📅 2026-09-23** | 驱动 CoPaper.AI 的因果推断引擎（900+ 函数，MIT 许可，JOSS 在投） |
...
由 <a href="https://copaper.ai"><strong>CoPaper.AI</strong></a> 维护，孵化于 <a href="https://reap.fsi.stanford.edu/"><strong>Stanford REAP</strong></a> · 由 [StatsPAI](https://github.com/brycewang-stanford/StatsPAI) ⭐ 323 | 🐛 0 | 🌐 Python | 📅 2026-09-23 驱动（900+ 函数，MIT）
