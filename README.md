...
[![Claude Code](https://img.shields.io/badge/agent-Claude%20Code-cc785c)](https://github.com/anthropics/claude-code) ⭐ 141,359 | 🐛 16,022 | 🌐 Python | 📅 2026-08-13
...
| **第三方收录（外链）**，例如 [nature-skills](https://github.com/Yuan1z0825/nature-skills) ⭐ 35,044 \| 🐛 0 \| 🌐 Python \| 📅 2026-08-13、[claude-scholar](https://github.com/Galaxy-Dawn/claude-scholar) ⭐ 5,102 \| 🐛 4 \| 🌐 Python \| 📅 2026-07-17 或 [codex-claude-academic-skills](https://github.com/zLanqing/codex-claude-academic-skills) ⭐ 2,851 \| 🐛 2 \| 🌐 Python \| 📅 2026-05-14 | 第三方上游包或通用学术工具，以外链形式收录（不再 vendored 进本仓库）。                 | 你需要跨期刊的研究、写作或工作流支持。            |
...
| 期刊                                 | 仓库                                                                                                              | 学科             | 状态       |
| ---------------------------------- | --------------------------------------------------------------------------------------------------------------- | -------------- | -------- |
| **Nature**（学术表达 + 科研绘图）            | [nature-skills](https://github.com/Yuan1z0825/nature-skills) ⭐ 35,044 \| 🐛 0 \| 🌐 Python \| 📅 2026-08-13     | 自然科学（Nature 系） | upstream |
| **Nature 风格手稿**（起草 · 修改 · 审计 · 重投） | [Nature-Paper-Skills](https://github.com/Boom5426/Nature-Paper-Skills) ⭐ 432 \| 🐛 0 \| 🌐 TeX \| 📅 2026-08-11 | 自然科学（Nature 系） | upstream |

### 通用研究工具 —— 第三方收录

| Pack                       | 仓库                                                                                                                                     | 范围                                           | 状态       |
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- | -------- |
| **Claude Scholar**         | [claude-scholar](https://github.com/Galaxy-Dawn/claude-scholar) ⭐ 5,102 \| 🐛 4 \| 🌐 Python \| 📅 2026-07-17                          | 选题 → 写作 → 发表（Claude Code / OpenCode / Codex） | upstream |
| **Codex/Claude 学术 Skills** | [codex-claude-academic-skills](https://github.com/zLanqing/codex-claude-academic-skills) ⭐ 2,851 \| 🐛 2 \| 🌐 Python \| 📅 2026-05-14 | 阅读 · 写作 · 科学计算                               | upstream |
...
* [academic-research-skills](https://github.com/Imbad0202/academic-research-skills) ⭐ 42,368 | 🐛 14 | 🌐 Python | 📅 2026-08-13 — 通用的 research → write → review → revise → finalize 科研流水线 skill 包。
* [Awesome-Agent-Skills-for-Empirical-Research](https://github.com/brycewang-stanford/Awesome-Agent-Skills-for-Empirical-Research) ⭐ 3,401 | 🐛 0 | 🌐 Stata | 📅 2026-08-10 — 精选 23,000+ agent skills，覆盖 8 大社科学科的实证研究（由 CoPaper.AI / Stanford REAP 维护）。

以外链形式收录（不再 vendored 进本仓库；点击前往各自上游仓库）：

* [nature-skills](https://github.com/Yuan1z0825/nature-skills) ⭐ 35,044 | 🐛 0 | 🌐 Python | 📅 2026-08-13
* [claude-scholar](https://github.com/Galaxy-Dawn/claude-scholar) ⭐ 5,102 | 🐛 4 | 🌐 Python | 📅 2026-07-17
* [codex-claude-academic-skills](https://github.com/zLanqing/codex-claude-academic-skills) ⭐ 2,851 | 🐛 2 | 🌐 Python | 📅 2026-05-14
* [Nature-Paper-Skills](https://github.com/Boom5426/Nature-Paper-Skills) ⭐ 432 | 🐛 0 | 🌐 TeX | 📅 2026-08-11

通用的科研写作 skill 包（定位不同——非特定期刊，仅供参考）：

* [Research-Paper-Writing-Skills](https://github.com/Master-cai/Research-Paper-Writing-Skills) ⭐ 6,018 | 🐛 0 | 📅 2026-06-23 —— ML/CV/NLP 论文写作，源自彭思达老师公开笔记。
* [claude-scientific-writer](https://github.com/K-Dense-AI/claude-scientific-writer) ⭐ 2,208 | 🐛 1 | 🌐 Python | 📅 2026-08-13 / [scientific-agent-skills](https://github.com/k-dense-ai/scientific-agent-skills) ⭐ 33,430 | 🐛 5 | 🌐 Python | 📅 2026-08-13 —— 通用科学写作。
* [academic-paper-skills](https://github.com/lishix520/academic-paper-skills) ⭐ 1,169 | 🐛 0 | 🌐 Python | 📅 2026-01-04 —— strategist（规划）+ composer（写作）双 skill，含质量检查点。
* [qinyan-academic-skills](https://github.com/LeonChaoX/qinyan-academic-skills) ⭐ 796 | 🐛 0 | 🌐 Python | 📅 2026-07-20 —— 沁言学术，177+ skill，覆盖 17 个学科。
* [agent-research-skills](https://github.com/lingzhi227/agent-research-skills) ⭐ 272 | 🐛 5 | 🌐 Python | 📅 2026-02-27 —— deep-research 系统性文献综述。
* [academic-writing-agents](https://github.com/andrehuang/academic-writing-agents) ⭐ 158 | 🐛 1 | 📅 2026-05-11 —— 多 agent 编排，含审稿/检索/起草/润色等专家 agent。
* [paper-writer-skill](https://github.com/kgraph57/paper-writer-skill) ⭐ 49 | 🐛 0 | 🌐 Python | 📅 2026-08-12 —— 全流程学术论文写作（IMRAD、文献管理、质量清单）。
* [literature-review-skill](https://github.com/YANZHANLIN/literature-review-skill) ⭐ 11 | 🐛 0 | 📅 2026-05-08 —— 5 步文献综述流水线（检索/获取/精读/综述/章节）。

自然科学 / 生命科学 skill 库（覆盖广，非特定期刊，仅供参考）：

* [claude-scientific-skills](https://github.com/K-Dense-AI/claude-scientific-skills) ⭐ 33,430 | 🐛 5 | 🌐 Python | 📅 2026-08-13（K-Dense）—— 140+ 科学 skill + 100+ 科学数据库，覆盖生物/化学/医学，兼容开放 Agent Skills 标准。
* [SciAgent-Skills](https://github.com/jaechang-hits/SciAgent-Skills) ⭐ 333 | 🐛 9 | 🌐 Python | 📅 2026-08-13 —— 197 个生物信息与生命科学 skill（RNA-seq、单细胞、蛋白组、药物发现）。
